...
public class SecurityConfig {
   ...
   private static final String[] PUBLIC_URLS = {"/user/new/password/**", "/user/verify/password/**", "/user/login/**", "/user/verify/code/**", "/user/register/**", "/user/resetpassword/**", "/user/verify/account/**", "/user/refresh/token/**", "/user/image/**", "/user/give/**"};
