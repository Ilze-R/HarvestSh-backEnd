...
public class CommentQuery {
    ...
    public static final String ADD_NOTIFICATION_ABOUT_COMMENT_LIKE = "INSERT INTO Notifications (user_id, action_user_id, message, is_read, created_at, forum_type, target, target_id, post_id) VALUES (:user_id, :action_user_id, :message, :is_read, :created_at, :forum_type, :target, :target_id, :post_id)";
    public static final String DELETE_NOTIFICATION_ABOUT_COMMENT_LIKE = "DELETE FROM Notifications WHERE forum_type = :forum_type AND target = :target AND target_id = :target_id AND post_id = :post_id";
