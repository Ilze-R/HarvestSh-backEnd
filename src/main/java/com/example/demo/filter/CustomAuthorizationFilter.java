...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
   ...
   private static final String[] PUBLIC_ROUTES = {"/user/new/password", "/user/register", "/user/login", "/user/verify/code", "/user/refresh/token", "/user/image", "/user/give/**", "/post/**", "/post/update/likes/**", "/user/**"};
